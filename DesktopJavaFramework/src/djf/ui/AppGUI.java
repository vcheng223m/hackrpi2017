...
public class AppGUI {
    ...
    private void initFileToolbar(AppTemplate app) {
        ...
        undoButton = initChildButton(fileToolbarPane,	UNDO_ICON.toString(),	    EXIT_TOOLTIP.toString(),	false);
        redoButton = initChildButton(fileToolbarPane,	REDO_ICON.toString(),	    EXIT_TOOLTIP.toString(),	false);
        aboutButton = initChildButton(fileToolbarPane,	ABOUT_ICON.toString(),	    EXIT_TOOLTIP.toString(),	false);
